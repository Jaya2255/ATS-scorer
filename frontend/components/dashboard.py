...
from frontend.components.strengths_issue import display_strengths, display_critical_issues
...
from frontend.components.recomendations import display_recommendations
